...
- (void)customPageView {
    ...
    DetailSubTwoVC *ctrl2 = [[DetailSubTwoVC alloc] init];
...
//        if ([ctrl isKindOfClass:[BaseTableViewController class]]) {
//            
...
//    }
    ...
    BaseTableViewController *vc0 = self.dataArray[0];
    vc0.canScroll = canScroll;
    if (!canScroll) {
        vc0.tableView.contentOffset = CGPointZero;
    }
    
    BaseTableViewController *vc2 = self.dataArray[2];
    vc2.canScroll = canScroll;
    if (!canScroll) {
        vc2.tableView.contentOffset = CGPointZero;
    }
    
    DetailSubTwoVC *vc3 = self.dataArray[1];
    vc3.canScroll = canScroll;
    if (!canScroll) {
        vc3.collectionView.contentOffset = CGPointZero;
    }
